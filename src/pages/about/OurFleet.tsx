...
const OurFleet = () => {
  ...
  return (
    <section className="lg:h-screen max-w-7xl mx-auto flex items-center justify-center">
        <div className="space-y-10">

      <div className="text-center space-y-3">
        <h2 className="text-4xl font-bold text-gray-900">Our Fleet</h2>
        <p className="text-gray-600">
          Experience unparalleled comfort, performance, and exclusivity with our
          exquisite fleet of vehicles.
        </p>
      </div>
      <div className="sm:flex justify-between items-center gap-10 ">
        <div className="flex-1">
          <h2 className="text-4xl font-bold text-gray-900">
            We offer customers a wide range of <span className="text-blue-700">commercial cars</span>  and <span className="text-blue-700">luxury cars</span>
            for any occasion.
          </h2>
        </div>
        <div className="flex-1">
